...
@section('content')
<h2 class="text-center nav-headers-links mt-5">Доставка</h2>
<div class="container mg-70">
    <h4 class="nav-headers-links fnts-24">Доставка почтой России</h4>
    ...
    <h4 class="nav-headers-links fnts-24">Курьерская доставка (Томск)</h4>
...
<div class="container mb-5">
    <div class="row">
        <div class="col-md-6 mb-4 mb-md-0 mt-5">
            <div>
                <h4 class="nav-headers-links fnts-24">Способы оплаты</h4>
                <ol>
            ...
            <div class="mt-5">
                <h4 class="nav-headers-links fnts-24">Контактная информация</h4>
