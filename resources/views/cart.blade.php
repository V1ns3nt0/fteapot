...
@section('content')
<h2 class="text-center nav-headers-links mt-5 mb-4">Корзина</h2>
@auth
               ...
               <div class="col-lg-8">
                   ...
                   <form id="makeOrder" method="POST" action="/cart/order">
                     ...
                     <div class="container" style="margin-top: 80px">
                         <h4 class="nav-headers-links">Доставка</h4>
                         <div class="row">
                     ...
                     <div class="container" style="margin-top: 50px">
                         <h4 class="nav-headers-links">Контактная информация</h4>
                         <div class="row">
                             <div class="col-lg-4 col-md-6 mb-4">
...
@guest
<section class="dark-grey-text" v-if="cart.length > 0">
           <div class="row mx-auto">
               <div class="col-lg-8">
                   <div class="table-responsive ">
                       <table class="table product-table border border-light mb-0">
                           <tbody>
                           <tr is ="cart-item" v-for="(product, index) in cart" :index="index" v-bind:key="product.id" :product="product" class="white"></tr>
                           </tbody>
                       </table>
                   </div>
                   <form id="makeOrder" method="POST" action="/cart/order">
...
<h2 class="text-center mt-5" v-if="cart.length === 0">Корзина пуста</h2>
@endguest
@endsection
